...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::session::list_character_knowledge,
            commands::session::apply_relationship_stage,
            commands::session::set_character_knowledge,
            commands::session::mark_characters_met,
